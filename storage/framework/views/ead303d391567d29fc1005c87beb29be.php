<?php $__env->startSection('title', 'Emlakçı Detayı'); ?>

<?php $__env->startSection('header-title', 'Emlakçı Detayı'); ?>
...
<div class="space-y-6">
        ...
        <div class="p-8">
            <div class="flex items-center space-x-6">
                ...
                <div class="flex-1 text-white">
                    <h1 class="text-3xl font-bold mb-2"><?php echo e($agent->user->name); ?></h1>
                    <p class="text-blue-200 text-lg">Emlakçı</p>
                </div>
                <div class="hidden md:flex space-x-4">
                    <?php if($agent->phone): ?>
                    <a href="tel:<?php echo e($agent->phone); ?>" class="px-4 py-2 bg-white bg-opacity-20 hover:bg-opacity-30 rounded-lg text-white flex items-center space-x-2 transition">
                    ...
                    <?php endif; ?>
                    <a href="mailto:<?php echo e($agent->user->email); ?>" class="px-4 py-2 bg-white bg-opacity-20 hover:bg-opacity-30 rounded-lg text-white flex items-center space-x-2 transition">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="bg-white rounded-lg shadow p-6">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-bold text-gray-900 mt-1"><?php echo e($agent->listings()->count()); ?></p>
                </div>
        ...
        <div class="bg-white rounded-lg shadow p-6">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-bold text-gray-900 mt-1"><?php echo e($agent->active_listings_count); ?></p>
                </div>
        ...
        <div class="bg-white rounded-lg shadow p-6">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-bold text-gray-900 mt-1"><?php echo e($agent->inquiries()->count()); ?></p>
                </div>
        ...
        <div class="bg-white rounded-lg shadow p-6">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-bold text-gray-900 mt-1"><?php echo e($agent->listings()->whereIn('status', ['sold', 'rented'])->count()); ?></p>
                </div>
    ...
    <div class="bg-white rounded-lg shadow p-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div class="flex items-start space-x-4">
                ...
                <div>
                    ...
                    <a href="mailto:<?php echo e($agent->user->email); ?>" class="text-gray-900 font-medium hover:text-blue-600"><?php echo e($agent->user->email); ?></a>
                </div>
            </div>
            ...
            <div class="flex items-start space-x-4">
                ...
                <div>
                    ...
                    <a href="tel:<?php echo e($agent->phone); ?>" class="text-gray-900 font-medium hover:text-green-600"><?php echo e($agent->phone); ?></a>
                </div>
            </div>
            <?php endif; ?>
            ...
            <div class="flex items-start space-x-4">
                ...
                <div>
                    ...
                    <a href="https://wa.me/<?php echo e(str_replace([' ', '-', '(', ')'], '', $agent->whatsapp)); ?>" target="_blank" class="text-gray-900 font-medium hover:text-green-600"><?php echo e($agent->whatsapp); ?></a>
                </div>
            </div>
            <?php endif; ?>
        </div>
        ...
        <div class="mt-6 pt-6 border-t border-gray-200">
            ...
            <p class="text-gray-600 leading-relaxed"><?php echo e($agent->bio); ?></p>
        </div>
        <?php endif; ?>
    </div>
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr class="hover:bg-gray-50 transition">
                        <td class="px-6 py-4">
                            ...
                            <?php if($listing->district): ?>
                            <div class="text-sm text-gray-500"><?php echo e($listing->district); ?></div>
                            <?php endif; ?>
                        </td>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                            <?php echo e($listing->created_at->format('d.m.Y')); ?>

                        </td>
                        <td class="px-6 py-4 whitespace-nowrap text-sm">
                            <a href="<?php echo e(route('listings.edit', $listing)); ?>" class="text-blue-600 hover:text-blue-900 font-medium">Düzenle</a>
                        </td>
                    </tr>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/eticajans/Desktop/Etic Ajans/Projeler/Mobil Uygulama/Emlak Script/resources/views/agents/show.blade.php ENDPATH**/ ?>