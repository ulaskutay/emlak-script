...
@section('header-title', 'Emlakçılar')
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div class="bg-white rounded-lg shadow hover:shadow-lg transition-shadow border border-gray-100 overflow-hidden">
            ...
            <div class="p-6 space-y-4">
                ...
                <div class="grid grid-cols-3 gap-4 pt-2">
                    <div class="text-center p-3 bg-blue-50 rounded-lg">
                        <p class="text-2xl font-bold text-blue-600">{{ $agent->listings_count }}</p>
                        <p class="text-xs text-gray-600 mt-1">Toplam İlan</p>
                    </div>
                    <div class="text-center p-3 bg-green-50 rounded-lg">
                        <p class="text-2xl font-bold text-green-600">{{ $agent->active_listings_count }}</p>
                        <p class="text-xs text-gray-600 mt-1">Aktif İlan</p>
                    </div>
                    <div class="text-center p-3 bg-yellow-50 rounded-lg">
                        <p class="text-2xl font-bold text-yellow-600">{{ $agent->inquiries_count }}</p>
            ...
            <div class="px-6 py-4 bg-gray-50 border-t border-gray-200">
                <a href="{{ route('agents.show', $agent) }}" class="w-full block text-center px-4 py-2 bg-primary-600 text-white rounded-lg hover:bg-primary-700 transition font-medium">
                    Detayları Görüntüle
                </a>
            </div>
        </div>
